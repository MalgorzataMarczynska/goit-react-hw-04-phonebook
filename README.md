# Application for storing phone book contacts - version with functional components. The application consists of a form and a contact list with the function of adding, filtering and deleting contacts. Phone book contacts are stored in localStorage. Components life cycle methods are used.
